...
export default function (){
    ...
    return <div className="mt-5">
        ...
        <button className="cursor-pointer text-gray-700
         bg-[#2a292721] hover:bg-[#50454534] focus:outline-none focus:ring-4 focus:ring-gray-300 font-bold rounded-lg text-sm px-5 py-2.5 me-2 mb-2 mt-2 w-full" onClick={async(e)=>{
            e.preventDefault()
